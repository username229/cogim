...
const translations = {
    pt: {
        ...
        'last-updated': 'Última atualização: 3 de Dezembro de 2025',
        'terms-intro': 'Bem-vindo à Cogim Galeria. Ao aceder ou utilizar o nosso serviço, o utilizador concorda em ficar vinculado a estes Termos de Serviço e à nossa Política de Privacidade.',
        'terms-section-1-title': '1. Aceitação dos Termos',
        'terms-section-1-content': 'O acesso e utilização do Serviço estão condicionados à aceitação e cumprimento destes Termos. Estes Termos aplicam-se a todos os visitantes, utilizadores e outros que acedam ou utilizem o Serviço. Se discordar de qualquer parte dos termos, não deverá aceder ao Serviço.',
        'privacy-intro': 'A sua privacidade é importante para nós. Esta Política de Privacidade descreve como a Cogim recolhe, utiliza e protege as informações do utilizador ao aceder e utilizar a nossa Galeria.',
        'contact-title': 'Contacto',
        'contact-text': 'Para qualquer questão sobre estes Termos, por favor contacte-nos através dos canais habituais da Cogim.'
    },
    en: {
        // Navigation
        'nav-home': 'Home',
        ...
        // FAQ Keys
        'faq-horarios-q': '🕒 Hours',
        'faq-horarios-a': '⏰ Our opening hours:\n\n📅 Mon to Fri: 8am to 5pm\n📅 Saturday: 9am to 1pm\n📅 Sunday: Closed',
        
        'faq-localizacao-q': '📍 Location',
        'faq-localizacao-a': '📍 We are located at:\n\n🏢 Av. 25 de Setembro\nMaputo, Mozambique',
        
        'faq-produtos-q': '🛋️ Products',
        ...
        'privacy-title': 'Cogim Privacy Policy',
        'last-updated': 'Last updated: December 3, 2025',
        'terms-intro': 'Welcome to Cogim Gallery. By accessing or using our service, you agree to be bound by these Terms of Service and our Privacy Policy.',
        'terms-section-1-title': '1. Acceptance of Terms',
        'terms-section-1-content': 'Access and use of the Service are conditional upon acceptance and compliance with these Terms. These Terms apply to all visitors, users and others who access or use the Service. If you disagree with any part of the terms, you should not access the Service.',
        'privacy-intro': 'Your privacy is important to us. This Privacy Policy describes how Cogim collects, uses and protects user information when accessing and using our Gallery.',
        'contact-title': 'Contact',
        'contact-text': 'For any questions about these Terms, please contact us through Cogim\'s usual channels.'
    }
};
...
function translatePage() {
    ...
    // Atualizar chatbot se estiver disponível
...
function changeLanguage(lang) {
    ...
    // Encontra o botão ativo e adiciona a classe
    ...
    // Salvar preferência em cookie (válido por 365 dias)
...
document.addEventListener('DOMContentLoaded', function() {
    // Carregar idioma do cookie ou usar português por padrão
    const savedLanguage = getCookie('preferredLanguage') || 'pt';
    changeLanguage(savedLanguage);
    
    console.log(`🌍 Sistema de tradução inicializado - Idioma: ${savedLanguage.toUpperCase()}`);
});